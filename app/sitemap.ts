...
export default async function sitemap(): Promise<MetadataRoute.Sitemap> {
  ...
  const staticPages: MetadataRoute.Sitemap = [
    ...
    { url: `${base}/tools/yoga-studio-break-even-calculator`, changeFrequency: "monthly", priority: 0.6 },
    { url: `${base}/tools/class-pack-price-calculator`, changeFrequency: "monthly", priority: 0.6 },
    { url: `${base}/tools/yoga-member-ltv-calculator`, changeFrequency: "monthly", priority: 0.6 },
    { url: `${base}/tools/class-capacity-utilization-calculator`, changeFrequency: "monthly", priority: 0.6 },
    { url: `${base}/tools/yoga-studio-retention-calculator`, changeFrequency: "monthly", priority: 0.6 },
    { url: `${base}/tools/reformer-pilates-capacity-calculator`, changeFrequency: "monthly", priority: 0.6 },
