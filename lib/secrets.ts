...
export const PLATFORM_KEYS = {
  ...
  paypal_client_id: {
    ...
    secret: false,
    label: "PayPal Client ID (platform)",
    group: "paypal",
    hint: "From developer.paypal.com → Apps. Used to charge studios for the SaaS.",
  },
  paypal_client_secret: {
    env: "PAYPAL_CLIENT_SECRET",
    secret: true,
    label: "PayPal Client Secret (platform)",
    group: "paypal",
    hint: "Pairs with the Client ID above.",
  },
  paypal_plan_studio: {
    env: "PAYPAL_PLAN_STUDIO",
    secret: false,
    label: "PayPal Plan ID — Studio tier",
    group: "paypal",
    hint: "Subscription plan ID from PayPal — Catalog → Plans.",
  },
  paypal_plan_multi: {
    env: "PAYPAL_PLAN_MULTI",
    secret: false,
    label: "PayPal Plan ID — Multi-studio tier",
    group: "paypal",
    hint: "Subscription plan ID from PayPal — Catalog → Plans.",
  },
  paypal_webhook_id: {
    ...
    secret: true,
    label: "PayPal webhook ID (platform)",
    group: "paypal",
    hint: "From developer.paypal.com → Webhooks. Used to verify event signatures.",
  },
  paypal_mode: {
    env: "PAYPAL_MODE",
    secret: false,
    label: "PayPal mode (platform)",
    group: "paypal",
    hint: '"live" for real money, "sandbox" for testing. Defaults to "live".',
  },
  platform_billing_provider: {
    ...
    group: "platform",
    hint: '"paypal", "razorpay" or "stripe". Picks which provider charges studios. Defaults to PayPal.',
  },
  cron_secret: {
    env: "CRON_SECRET",
    secret: true,
